...
class ExpressionStringNamespace(ExpressionNamespace):
    def contains(self, substr: str | Expression) -> Expression:
        ...
        return Expression._from_pyexpr(native.utf8_contains(substr_expr._expr))
    ...
    def match(self, pattern: str | Expression) -> Expression:
        ...
        return Expression._from_pyexpr(native.utf8_match(pattern_expr._expr))
    ...
    def endswith(self, suffix: str | Expression) -> Expression:
        ...
        return Expression._from_pyexpr(native.utf8_endswith(suffix_expr._expr))
    ...
    def startswith(self, prefix: str | Expression) -> Expression:
        ...
        return Expression._from_pyexpr(native.utf8_startswith(prefix_expr._expr))
    ...
    def split(self, pattern: str | Expression, regex: bool = False) -> Expression:
        ...
        """
        pattern_expr = Expression._to_expression(pattern)
        return Expression._from_pyexpr(native.utf8_split(pattern_expr._expr, regex))
    ...
    def extract(self, pattern: str | Expression, index: int = 0) -> Expression:
        ...
        """
        pattern_expr = Expression._to_expression(pattern)
        return Expression._from_pyexpr(native.utf8_extract(pattern_expr._expr, index))
    ...
    def extract_all(self, pattern: str | Expression, index: int = 0) -> Expression:
        ...
        """
        pattern_expr = Expression._to_expression(pattern)
        return Expression._from_pyexpr(native.utf8_extract_all(pattern_expr._expr, index))
    ...
    def replace(
        ...
        return Expression._from_pyexpr(native.utf8_replace(pattern_expr._expr, replacement_expr._expr, regex))
    ...
    def length(self) -> Expression:
        ...
        """
        return Expression._from_pyexpr(native.utf8_length())
    ...
    def length_bytes(self) -> Expression:
        ...
        Returns:
            Expression: an UInt64 expression with the length of each string
        """
        return Expression._from_pyexpr(native.utf8_length_bytes())
    ...
    def lower(self) -> Expression:
        ...
        """
        return Expression._from_pyexpr(native.utf8_lower())
    ...
    def upper(self) -> Expression:
        ...
        """
        return Expression._from_pyexpr(native.utf8_upper())
    ...
    def lstrip(self) -> Expression:
        ...
        """
        return Expression._from_pyexpr(native.utf8_lstrip())
    ...
    def reverse(self) -> Expression:
        ...
        """
        return Expression._from_pyexpr(native.utf8_reverse())
    ...
    def left(self, nchars: int | Expression) -> Expression:
        ...
        return Expression._from_pyexpr(native.utf8_left(nchars_expr._expr))
    ...
    def right(self, nchars: int | Expression) -> Expression:
        ...
        """
        nchars_expr = Expression._to_expression(nchars)
        return Expression._from_pyexpr(native.utf8_right(nchars_expr._expr))
    ...
    def find(self, substr: str | Expression) -> Expression:
        ...
        """
        substr_expr = Expression._to_expression(substr)
        return Expression._from_pyexpr(native.utf8_find(substr_expr._expr))
    ...
    def rpad(self, length: int | Expression, pad: str | Expression) -> Expression:
        ...
        return Expression._from_pyexpr(native.utf8_rpad(length_expr._expr, pad_expr._expr))
    ...
    def lpad(self, length: int | Expression, pad: str | Expression) -> Expression:
        ...
        length_expr = Expression._to_expression(length)
        pad_expr = Expression._to_expression(pad)
        return Expression._from_pyexpr(native.utf8_lpad(length_expr._expr, pad_expr._expr))
    ...
    def repeat(self, n: int | Expression) -> Expression:
        ...
        return Expression._from_pyexpr(native.utf8_repeat(n_expr._expr))
    ...
    def like(self, pattern: str | Expression) -> Expression:
        ...
        """
        pattern_expr = Expression._to_expression(pattern)
        return Expression._from_pyexpr(native.utf8_like(pattern_expr._expr))
    ...
    def ilike(self, pattern: str | Expression) -> Expression:
        ...
        """
        pattern_expr = Expression._to_expression(pattern)
        return Expression._from_pyexpr(native.utf8_ilike(pattern_expr._expr))
    ...
    def substr(self, start: int | Expression, length: int | Expression | None = None) -> Expression:
        ...
        length_expr = Expression._to_expression(length)
        return Expression._from_pyexpr(native.utf8_substr(start_expr._expr, length_expr._expr))
    ...
    def to_datetime(self, format: str, timezone: str | None = None) -> Expression:
        ...
        """
        return Expression._from_pyexpr(native.utf8_to_datetime(format, timezone))
    ...
    def normalize(
        ...
        *,
        ...
        """
        return Expression._from_pyexpr(native.utf8_normalize(remove_punct, lowercase, nfd_unicode, white_space))
