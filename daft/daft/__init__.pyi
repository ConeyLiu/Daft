...
# expr.utf8 namespace
# ---
def utf8_endswith(pattern: PyExpr) -> PyExpr: ...
def utf8_startswith(pattern: PyExpr) -> PyExpr: ...
def utf8_contains(pattern: PyExpr) -> PyExpr: ...
def utf8_match(pattern: PyExpr) -> PyExpr: ...
def utf8_split(pattern: PyExpr, regex: bool) -> PyExpr: ...
def utf8_extract(pattern: PyExpr, index: int) -> PyExpr: ...
def utf8_extract_all(pattern: PyExpr, index: int) -> PyExpr: ...
def utf8_replace(pattern: PyExpr, replacement: PyExpr, regex: bool) -> PyExpr: ...
def utf8_length() -> PyExpr: ...
def utf8_length_bytes() -> PyExpr: ...
def utf8_lower() -> PyExpr: ...
def utf8_upper() -> PyExpr: ...
def utf8_lstrip() -> PyExpr: ...
def utf8_rstrip() -> PyExpr: ...
def utf8_reverse() -> PyExpr: ...
def utf8_capitalize() -> PyExpr: ...
def utf8_left(nchars: PyExpr) -> PyExpr: ...
def utf8_right(nchars: PyExpr) -> PyExpr: ...
def utf8_find(substr: PyExpr) -> PyExpr: ...
def utf8_rpad(length: PyExpr, pad: PyExpr) -> PyExpr: ...
def utf8_lpad(length: PyExpr, pad: PyExpr) -> PyExpr: ...
def utf8_repeat(n: PyExpr) -> PyExpr: ...
def utf8_like(pattern: PyExpr) -> PyExpr: ...
def utf8_ilike(pattern: PyExpr) -> PyExpr: ...
def utf8_substr(start: PyExpr, length: PyExpr) -> PyExpr: ...
def utf8_to_date(format: str) -> PyExpr: ...
def utf8_to_datetime(format: str, timezone: str | None = None) -> PyExpr: ...
def utf8_normalize(remove_punct: bool, lowercase: bool, nfd_unicode: bool, white_space: bool) -> PyExpr: ...
